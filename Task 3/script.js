...
const java = document.getElementById('skill_2');
...
const resetForm = function () {
  ...
  const html = document.querySelectorAll('input[name="skill"]');
    htmlchecked = false;

const java = document.querySelectorAll('input[name="skill"]');
java.checked = false;
const css = document.querySelectorAll('input[name="skill"]');
css.checked = false;
};
